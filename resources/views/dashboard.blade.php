...
<!-- @endif -->
    ...
    <thead>
        <tr>
        <div class="pull-right">
                <a class="btn btn-success bg-green-600 py-2 px-4 rounded " href="{{ route('categorys.create') }}"> Create New Category</a>
            </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="py-2 px-4 border-b">
                <form action="{{ route('categorys.destroy', $category->id) }}" method="POST" class="flex">
                    <a class="btn btn-info mr-2 bg-orange-400 py-2 px-4 rounded " href="{{ route('categorys.show', $category->id) }}">Show</a>
                    <a class="btn btn-primary mr-2 bg-blue-700 py-2 px-4 rounded " href="{{ route('categorys.edit', $category->id) }}">Edit</a>
                    @csrf
                    @method('DELETE')
